...
- When a routine is derived from a specific saved Fact, set routine.sourceFactId to that Fact's real ID so deleting or expiring the source can stop future recurrence without erasing completed history.
